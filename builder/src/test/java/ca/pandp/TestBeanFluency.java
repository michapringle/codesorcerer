...
import ca.pandp.template.BN_SBN.Complex5;
import ca.pandp.template.BN_SBN.Simple5;
import ca.pandp.template.BN_SBNN.Complex4;
import ca.pandp.template.BN_SBNN.Simple4;
import org.junit.Test;

import ca.pandp.template.Complex;
import ca.pandp.template.Simple;
import ca.pandp.template.Thing;
import ca.pandp.template.BNN_SBN.Complex3;
...
public class TestBeanFluency {
    ...
    public void testComplexAllValidFluentPaths() {
        ...
        final ca.pandp.template.Thing.SubBeanUpdatable<Complex.BeanUpdateable> u6 = u5.getThing();
        final ca.pandp.template.Thing.SubBeanUpdatable<Complex.BeanUpdateable> u7 = u6.that("");
