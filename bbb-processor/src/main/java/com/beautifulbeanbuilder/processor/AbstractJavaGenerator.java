...
public abstract class AbstractJavaGenerator <T extends Annotation, Input> extends AbstractGenerator<T, Input, TypeSpec.Builder> {
	...
	protected TypeSpec.Builder getTypeBuilder(Class<? extends AbstractJavaBeanGenerator> generatorClass, Map<AbstractGenerator, Object> generatorBuilderMap) {
		for (Map.Entry<AbstractGenerator, Object> e : generatorBuilderMap.entrySet()) {
