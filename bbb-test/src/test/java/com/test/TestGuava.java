...
import static com.test.template.BeanValGuava.EQUALS_MYBOOL;
import static com.test.template.BeanValGuava.EQUALS_MYBOOL_WRAPPER;
import static com.test.template.BeanValGuava.EQUALS_MYINTMAX100;
import static com.test.template.BeanValGuava.ORDER_BY_MYINTMAX100;
import static com.test.template.BeanValGuava.TO_MYINTMAX100;
import static com.test.template.BeanValGuava.TO_MYSTRINGPATTERN;
import static com.test.template.BeanValGuava.byMyIntMax100;
...
import com.test.bean.sub.FooGuava;
import com.test.template.BeanVal;
import com.test.template.BeanValGuava;
import com.test.template.Complex;
import com.test.template.ComplexGuava;
import com.test.template.David;
import com.test.template.Special;
import com.test.template.interfaces.SpecialChild;
